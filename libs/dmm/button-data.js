// DMM button data moved out of the userscript for reuse
// This file sets a global `DMM_BUTTON_DATA` which the userscript will read.
(function () {
  'use strict';
  ...
  window.DMM_BUTTON_DATA = [
    ...
    },
    {
      name: 'Extra',
      buttonData: [
        { name: 'Extra', value: "\\b(QxR|UTR|Joy|Silence|Vyndros|ReVyndros|Ghost|Tigole|D3g|TAoE|PSA|BeiTai|userHEVC)\\b" },
      ],
    },
  ];
})();
